...
If you want to try and reproduce the crash the easiest way is to run `run_and_hopefully_crash.bash`, which will run everything through Docker so you can see the issue yourself.
