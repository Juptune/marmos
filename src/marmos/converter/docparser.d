 ...
 */
module marmos.converter.docparser;

import std.typecons : Nullable, nullable;
import marmos.converter.model;
    ...
    while(info.line.length > 0)
    {
        ...
        final switch(lineType) with(ListLineType)
        {
            ...
            case isNewItem:
                ...
                item.nestingLevel = 1; // TODO: Support multiple nesting levels properly (this code is just copy-pasted from old marmos, otherwise I'd have bothered from the start)
                break;
