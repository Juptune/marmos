...
dub fetch argparse
dub build argparse --compiler=ldc2
...
# /tmp/marmos-dustmite docs generate -d ../scratchpad 2>&1 && echo "We didn't crash"
/tmp/marmos-dustmite docs generate -d ../scratchpad 2>&1 | grep -F "Invalid tag"